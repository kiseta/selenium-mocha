...
const { Builder } = require("selenium-webdriver"); // Import the `Builder` class from the `selenium-webdriver` module. The `Builder` class is used to create new instances of a `WebDriver` object that can control a browser.
const { By } = require("selenium-webdriver"); // Import the `By` class from the `selenium-webdriver` module. The `By` class is used to locate elements on a webpage, such as finde elements by their `id`, `name`, `class`, or `css` selector.
